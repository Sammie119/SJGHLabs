...
@section('title', 'SJGH-LRMS | Edit Test')
          ...
          {{-- General Information --}}
                  <div id="Info" class="tabcontent">
                    ...
                    <hr>
                      <div class="row justify-content-center">
                          <div class="col-md-6">
                              <div class="form-group"> 
                                ...
                                <input type="text" name="lab_no" value="{{ $haema->lab_number }}" id="lab_no" class = "form-control" maxlength="10" readonly>
                              </div>
                          </div>
                      </div>
                      <div class="row justify-content-center">
                      ...
                      <div class="row justify-content-center">
                          <div class="col-md-6">
                              <div class="form-group"> <label for="opd_no">OPD Number</label> <input type="text" name="opd_no" value="{{ $haema->opd_number }}" id="opd_no" class = "form-control" maxlength="10" required ></div>
                          </div>
                      </div>
                      <div class="row justify-content-center">
                          <div class="col-md-5">
                              <div><label for="name">Patient's Name</label><input type="text" class="form-control" id="name" name="name" value="{{ $haema->name }}" readonly> </div>
                          </div>
                          <div class="col-md-1">
                            <div> <label for="age">Age</label> <input type="text" class="form-control" id="age" name="age" value="{{ $haema->age }}" readonly > </div>
                        </div>
                      </div>
                      <div class="row justify-content-center">
                          <div class="col-md-6">
