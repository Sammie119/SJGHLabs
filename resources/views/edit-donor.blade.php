...
@section('title', 'SJGH-LRMS | Edit Donor')
    ...
    <div class="container" style="margin-top: -2%;">
        <div class="card">
            <div class="card-header">
                <h2><b style="color: #191970;">Edit Donor</b>
                    <a href="{{ route('donors-list') }}" class="btn btn-info float-right">Donors List</a>
                </h2>
            </div>
            <div class="card-body">
                <form action="{{ route('update-donor') }}" method="POST" autocomplete="off" onsubmit="return validateForm()">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                            <div class="form-group"> <label for="name">Donor's Name</label> 
                                <input type="text" name="name" value="{{ $donor->name }}" id="name" class="form-control" style="width: 66.5%;" required>
                            </div>    
                        </div>
                    </div>
                    <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="pus_cell">Date of Birth</label> 
                                <input type="date" name="dob" id="dob" value="{{ $donor->date_of_birth }}" max="<?php echo date('Y-m-d');?>" onchange="Javascript:myAgeValidation()" required style="height: 35px;">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="red_cell">Marital Status</label> 
                                <select id="marital_status" name="marital_status" class="form-control" required style="height: 35px;">
                                    <option>{{ $donor->marita_status }}</option>
                    ...
                    <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="pus_cell">Profession</label> 
                                <select name="profession" id="profess" class="form-control" style="height: 35px;" required>
                                    <option>{{ $donor->profession }}</option>
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="red_cell">Contact</label> 
                                <input type="text" name="contact" value="{{ $donor->mobile }}" id="contact" class = "form-control" maxlength="10"></div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                            <div class="form-group"> <label for="name">Address</label> 
                                <input type="text" id="address" name="address" value="{{ $donor->address }}" class="form-control" style="width: 66.5%;" required>
                            </div>    
                        </div>
                    </div>
