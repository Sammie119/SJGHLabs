...
@section('title', 'SJGH-LRMS | Stock Blood Bank')
    ...
    <div class="container" style="margin-top: -2%;">
        <div class="card">
            <div class="card-header">
                <h2><b style="color: #191970;">Stock Blood Bank</b>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="epi_cell">Blood Taken Date</label> 
                                <input type="date" name="date_taken" id="date_taken" max="<?php echo date('Y-m-d');?>" style="height: 35px;" required></div>
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="epi_cell">Blood Expiry Date</label> 
                                <input type="date" name="exp_date" id="exp_date" min="<?php echo date('Y-m-d');?>" required style="height: 35px;"></div>
                        </div>
                    </div>
