...
@section('content')
    <div class="container" style="margin-top: -2%;">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('edit-profile') }}" method="POST" autocomplete="off" onsubmit="return validateForm()">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-lg-10 col-12">
                            <div class="form-group"> <label for="name">Name</label> 
                                <input type="text" name="name" id="name" value="{{ $user->name }}" class="form-control" style="width: 100%;" required>
                            </div>    
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="department">Department</label> 
                                <select class = "form-control" id="department" name="department" style="width: height: 35px;" required>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="lab_no">Username</label> 
                                <input type="text" class = "form-control" name="username" value="{{ $user->username }}" required></div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6 col-sm-12">
