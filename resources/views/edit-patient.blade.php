...
@section('title', 'SJGH-LRMS | Edit Patient')
    ...
    <div class="container" style="margin-top: -2%;">
        <div class="card">
            <div class="card-header">
                <h2><b style="color: #191970;">Edit Patient</b>
                    <a href="{{ route('patients-list') }}" class="btn btn-info float-right">Patients List</a>
                </h2>
            </div>
            <div class="card-body">
                <form action="{{ route('update-patient') }}" method="POST" autocomplete="off" onsubmit="return validateForm()">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="pus_cell">OPD Number</label> 
                                <input type="text" name="opd_no" id="opd_no" value="{{ $patient->opd_number }}" maxlength="10" class="form-control" style="height: 35px;" required>
                                    </div>
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                            <div class="form-group"> <label for="name">Name</label> 
                                <input type="text" name="name" id="name" value="{{ $patient->name }}" class="form-control" style="width: 66.5%;" required>
                            </div>    
                        </div>
                    </div>
                    <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="form-group"> <label for="pus_cell">Date of Birth</label> 
                                <input type="date" name="dob" id="dob" value="{{ $patient->date_of_birth }}" max="<?php echo date('Y-m-d');?>" onchange="Javascript:myAgeValidation()" required style="height: 35px;">
